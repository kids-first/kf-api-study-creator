...
from creator.files.models import extract_config_path, Version
from creator.analyses.file_types import FILE_TYPES
from creator.analyses.analyzer import extract_data

ROOT_DIR = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
EXTRACT_CFG_DIR = os.path.join(ROOT_DIR, "extract_configs", "templates")
...
def build_report(results):
    ...
    for version in versions:
        fname = FILE_TYPES[version.root_file.file_type]["name"]
        friendly_names.append(f"{fname}, {version.kf_id}")
